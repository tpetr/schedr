...
from schedr.uri import models as uri_app
from schedr.uri.models import Major, Term, Location
from schedr.uri import settings, importer
from schedr import settings as site_settings

def setup_school_uri(app, created_models, verbosity, **kwargs):
...
signals.post_syncdb.connect(setup_school_uri, sender=uri_app)

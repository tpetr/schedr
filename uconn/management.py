...
from schedr.uconn import models as uconn_app
from schedr.uconn.models import Major, Term, Location
from schedr.uconn import settings, importer
from schedr import settings as site_settings

def setup_school_uconn(app, created_models, verbosity, **kwargs):
...
signals.post_syncdb.connect(setup_school_uconn, sender=uconn_app)
